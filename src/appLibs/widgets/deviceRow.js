...
export const DeviceRowNavPage = GObject.registerClass({
    ...
    _init(path, alias, icon, navView, devicesGrp, appDir, dataHandler) {
        ...
        this._dataHandlerId = this._dataHandler.connect('properties-changed', () =>  {
            ...
            this._circleBattWidget.updateValues(level, status);
            if (this._toggle1Grp)
        ...
        this._dataHandlerId2 = this._dataHandler.connect('configuration-changed', () =>  {
    ...
    _addLabelIndicators(page, count) {
        ...
        this._labelIndicatorSignalId =
            this._dataHandlerId3 = this._dataHandler.connect('properties-changed', () => {
    ...
    destroy() {
        ...
        this._dataHandlerId2 = null;

        if (this._dataHandlerId3 && this._dataHandler)
