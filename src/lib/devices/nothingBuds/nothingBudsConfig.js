...
export const PayloadType = {
    ...
    BATTERY_GET: 0xC007,
    BATTERY_PRIMARY_NTFY: 0xE001,
    BATTERY_SECONDARY_NTFY: 0x4007,

    LED_CASE_COLORS_GET: 0xC017,
    LED_CASE_COLORS_SET: 0xF00D,
    LED_CASE_COLORS_NTFY: 0x4017,
    ...
    ANC_SECONDARY_NTFY: 0x401E,

    PERSONALIZED_ANC_GET: 0xC020,
    PERSONALIZED_ANC_SET: 0xF011,
    PERSONALIZED_ANC_NTFY: 0x4020,

    EQ_GET: 0xC01F,
    EQ_SET: 0xF010,
    EQ_NTFY: 0x401F,

    ADVANCED_EQ_GET: 0xC04C,
    ADVANCED_EQ_ENABLED_SET: 0xF04F,
    ADVANCED_EQ_NTFY: 0x404C,

    CUSTOM_EQ_GET: 0xC044,
    CUSTOM_EQ_SET: 0xF041,
    CUSTOM_EQ_NTFY: 0x4044,

    ENHANCED_BASS_GET: 0xC04E,
    ENHANCED_BASS_SET: 0xF051,
    ENHANCED_BASS_RET: 0x404E,
    ENHANCED_BASS_NTFY: 0x7051,

    LISTENING_MODE_GET: 0xC050,
    LISTENING_MODE_SET: 0xF01D,
    LISTENING_MODE_NTFY: 0x4050,

    SPATIAL_AUDIO_GET: 0xC04F,
    SPATIAL_AUDIO_SET: 0xF052,
    SPATIAL_AUDIO_NTFY: 0x404F,
    ...
    EAR_FIT_TEST_NTFY: 0xE00D,

    DUAL_CONNECTION_GET: 0xC027,
    DUAL_CONNECTION_SET: 0xF01A,
    DUAL_CONNECTION_RET: 0x4027,
    DUAL_CONNECTION_NTFY: 0xE006,

    DUAL_CONNECTION_DEVICES_GET: 0xC028,
    DUAL_CONNECTION_DEVICES_SET: 0xF01B,
    DUAL_CONNECTION_DEVICES_RET: 0x4028,
    DUAL_CONNECTION_DEVICES_NTFY: 0xE00E,
};

const crc16AnsiTab = Uint16Array.from([
...
export function crc16Ansi(buffer) {
    let crc = 0xFFFF;
    for (const b of buffer)
        crc = crc16AnsiTab[(crc ^ b) & 0xFF] ^ crc >> 8;
